...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  postPatch = ''
    ...
    # `connectors::list_connectors` nests futures deeply enough that computing
    # the layout of its async fn body overflows rustc's query depth limit,
    # which is derived from the crate's `recursion_limit`.
