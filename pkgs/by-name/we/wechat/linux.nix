...
let
  ...
  # WeChat's statically linked Qt renders the variable Noto CJK fonts at their
  # default Thin weight (e.g. in the message input box). Hide them from WeChat
  # and provide the static fonts instead.
